...
all.point.scores <- Point.scores %>% 
  ...
  #mutate(Meter_from_ditch = as.numeric(Meter_from_ditch)) #USE # to create # for NMDS plot 
  mutate(Meter_from_ditch = as.factor(Meter_from_ditch))   #USE # for regression and regression plot
